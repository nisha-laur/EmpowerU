...
export default ({
  ...
  description = "Client Feedback on EmpowerU's Verified Learners",
  testimonials = null,
  textOnLeft = false
}) => {
  /*
  ...
  const defaultTestimonials = [
    {
      ...
      quote:
        "EmpowerU's verified learners brought a fresh perspective to our mobile app project. Their proficiency in Flutter and Firebase resulted in a feature-rich app that delighted our users. The team's commitment to excellence and willingness to go the extra mile made a significant impact on the app's success. We are extremely pleased with their work and will undoubtedly hire from EmpowerU again.",
      customerName: "Sarah Johnson",
      customerTitle: "Product Manager, HealthTech Solutions Ltd."
    },
    {
      imageSrc:
      ...
      quote:
        "Sinorrr Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia.",
