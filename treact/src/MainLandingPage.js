...
import heroScreenshotImageSrc from "images/demo/women.png";
import logo from "images/Empoweru.jpg";
...
export default ({
  ...
  secondaryButtonText = "Get Hired!",
  buttonRoundedCss = "",
  landingPages = components.landingPages,
  innerPages = components.innerPages,
  blocks = components.blocks,
  heading = "Your Journey to Empowerment Starts Here: EmpowerU - Enroll Today!",
  description = "EmpowerU is a transformative platform, breaking barriers and creating opportunities for marginalized individuals , including young women and homemakers , to achieve financial independence and professional success. Our free courses, mentorship, and job support foster growth and self-discovery. Join our vibrant community to unlock potential, collaborate, and embark on a journey of empowerment. Empower yourself. Empower your future. EmpowerU."
}) => {
  /*
      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          ...
          <SectionContainer id="landingPageDemos">
            <SectionHeading>EmpowerU: Where Features Fuel Growth and Success</SectionHeading>
            <SectionDescription>
            EmpowerU: Elevate your journey to success. Free courses, expert mentorship, collaborative learning, job support, and global reach. Unleash your potential today!
            </SectionDescription>
            <PreviewCards>
              {Object.entries(landingPages).map(([pageName, page], index) => (
                <PreviewCardContainer key={index}>
                  <PreviewCard initial="rest" animate="rest" whileHover="hover" href={page.url} target="_blank">
                    ...
                    <PreviewButton>Visit the page </PreviewButton>
                  </PreviewCard>
